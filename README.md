...
![](/images/{9E49EBF0-970E-4DDD-AD8A-EA57437CAF7E}.png)

Chọn nút **Join** ở góc trên bên phải:
![](/images/{FB070714-A3CB-43FD-A1C1-B17A3A09E2DA}.png)
...
![](/images/{ADFB0B32-760E-4AEC-8967-C5BBC28A102E}.png)
...
![](/images/{5FBC19DB-739F-4CB7-AC5C-C607B3E501E9}.png)

Chạy file `MinecraftInstaller.exe`
![](/images/{CE8CCF00-EA77-4110-9438-047C31A9922E}.png)
...
![](/images/{8D9D47CB-4995-4EE4-B776-5D99AD260F97}.png)

Tiến hành login vào tài khoản Microsoft đã mua game.
![](/images/{D6D51C66-FAAE-452E-95CB-46ABCB42B187}.png)

Tích vào nút **Microsoft apps only**
![](/images/{AB555FD2-36B3-4D4E-9DF0-6E734E7EE153}.png)

Chọn **Let's Go** để vào launcher. Đợi một lúc để launcher tải dữ liệu.
![](/images/{15E2F87E-79DD-4FF1-9D02-4179BFF2BF77}.png)

Nếu xuất hiện thông báo này, hãy bấm **Close**.
![](/images/{E9D61701-FB11-48C7-9A96-5DFDB1994F94}.png)
...
![](/images/{B07AFDB6-30B9-46DA-A303-DF040EEB0447}.png)

**Finish** để hoàn tất.
![](/images/{E149F8C5-5F32-4E32-98E4-9215E620017D}.png)

Sau khi Legacy Launcher mở lên, hãy chọn **Create and Manage accounts**
![](/images/{7C1E90A6-373C-48AA-BA4D-BD729CE3A6D0}.png)

Chọn dấu *cộng* bên trái, rồi chọn **Ely.by skin system**
![](/images/{470A808A-43F9-40DD-BE54-F98843C4E040}.png)

Chọn **Log in to Ely.by** và **Open your browser**.
![](/images/{43D08CEF-C431-4574-A61D-038F3DAC56C5}.png)

Chọn account mà bạn đã tạo trước đó.
![](/images/{889F9217-A997-407F-BC0E-17730D871B16}.png)

Chọn **Approve**
![](/images/{0A55BB4C-D99D-43CC-8C7C-1EF3E010E90F}.png)

Như vậy là đã đăng nhập thành công, trình duyệt sẽ hiện thị như sau.
![](/images/{99D6405D-84AF-4005-A7AA-625212664645}.png)

Còn Launcher sẽ xuất hiện tài khoản của bạn, hãy chọn nút *ngôi nhà* về về màn hình chính.
![](/images/{C018856B-7B0B-4A35-9846-4B03686CD7B5}.png)
...
![](/images/{9808D660-FF79-489D-B4D3-0A45EB09CE8F}.png)
***
...
![](/images/{0C3AD15D-3612-4985-8935-1E9D6DAD64D8}.png)
...
![](/images/{8BDC1510-CBF4-461E-BAE0-E44E51A2F6F0}.png)

Chọn **YES**.
![](/images/{B0B1896D-18AB-4898-91AE-FDF65524E983}.png)

Vậy là thành công cài đặt Fabric Loader.
![](/images/{59B8452D-D86E-46DC-8E79-1DA68236FBF5}.png)
...
![](/images/{4A2906A5-79B1-4B54-8165-0EA0E70AFDD4}.png)

Chọn **More Options** để hiện thị các tuỳ chọn nâng cao:
![](/images/{8FCCF086-C47F-44E3-9155-42A3E6161969}.png)
...
![](/images/{9ED2F956-D382-4577-9D37-0769FE794D9D}.png)

Tích vào ô **Skip Java runtime version check** để tránh các vấn đề không mong muốn.
![](/images/{8753155D-D2B5-4EBC-A35F-1F0B27BB8280}.png)
...
![](/images/{459DE9AF-F622-4DD6-83D5-456759D38EEB}.png)
...
![](/images/{07A2148B-4840-44BC-8CA9-4A098438A374}.png)

Tiếp theo, mở thư mục game bằng các chọn vào nút **Open installations folder**.
![](/images/{F64E0078-47F8-412D-BC3A-515B077E54B8}.png)

Một cửa số Explorer sẽ mở ra:
![](/images/{B30ED859-8738-4143-B13F-B6B1969BACE1}.png)
...
![](/images/{8201E4C3-8F50-4975-959F-42D93F531F93}.png)
...
![](/images/{E52941FB-41AD-4252-90DB-54090EEB3399}.png)

Mở [Flags.sh](https://flags.sh) và copy phần được bôi đen:
![](/images/{922031BA-F1AF-4C1C-92FD-78286B4E4E1A}.png)
...
Paste những file vừa copy vào thư mục ban nãy:
![](/images/{FD0F8F23-FA71-401B-A9AF-31F82BA29E32}.png)
...
![](/images/{6289C25E-6E37-4EB6-BDFB-073C9F8D4194}.png)

Chọn Instance **1.21.4** bạn vừa tạo, click nút **Folder** ở bên phải.
![](/images/{25799A22-8CAC-4237-AB52-9EF9FB2A0FDE}.png)

Một cửa số Explore sẽ hiện ra:
![](/images/{EF398F8D-B3BE-4BC9-8DDE-594EFBB3F540}.png)

Chọn thư mục `minecraft`:
![](/images/{4B52BC89-2F73-44A9-AEDC-324E4E7EE3E0}.png)
...
Paste những file vừa copy vào thư mục ban nãy:
![](/images/{1FAD38E0-833E-42D8-AD3C-9749054DA0D6}.png)

Quay trở lại Prism Launcher, chọn nút **Launch** bên phải để mở game.
![](/images/{714B4670-9FBD-4FAC-B7B9-3ADEDEF3F6F5}.png)
***
...
Chọn **Options**.
![](/images/{21A88039-23C0-47C4-9075-6B8C08F5D04E}.png)

Tại đây, hãy chỉnh thông số **FOV** cho phù hợp với bạn:
![](/images/{5D446C76-26B2-43ED-B35E-3C9B91E9F1F6}.png)

Ví dụ cho FOV cao:
![](/images/{8C9E943C-B160-4588-9B85-E945ACFC4BC8}.png)

Ví dụ cho FOV thấp:
![](/images/{48E5D9B5-5B2B-4AF0-92B9-1EBEC0414420}.png)

Sau khi đã chỉnh FOV phù hợp, chọn mục **Controls**:
![](/images/{B8975C09-7E18-49A7-910F-F76C2FD0F0E1}.png)

Để chỉnh độ nhạy chuột, vào **Mouse Settings**. Ở mục **Sensitivity**, tăng hoặc giảm độ nhạy chuột theo thói quen sử dụng của bạn. 
![](/images/{B205F5E0-D280-46FD-8F4D-4B86640EB5C4}.png)

Trở lại mục **Controls**, chọn **Key Binds** để chính nút chuột và bàn phím:
![](/images/{4B2B623F-D973-4C41-9296-10104896154A}.png)
...
![](/images/{D4219945-F95C-4BA8-BD30-796DA92F6B80}.png)
